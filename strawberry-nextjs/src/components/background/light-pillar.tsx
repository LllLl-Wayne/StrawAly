...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  }, [topColor, bottomColor, intensity, rotationSpeed, interactive, glowAmount, pillarWidth, pillarHeight, noiseIntensity, pillarRotation, webGLSupported, theme])

  useEffect(() => {
    if (!sceneRef.current) return
    sceneRef.current.background = theme !== 'dark' ? new THREE.Color(0xffffff) : null
  }, [theme])
